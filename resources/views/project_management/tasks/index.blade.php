...
@endif --}}
<div class="tasks_container mt-5">
    <div class="acrodian side_open">
        <div class="task_list open">
            <div class="tasks_list" style="flex: 1;">
                <h4 class="tlt"><i class="fa-solid fa-list-ul"></i> Task Lists <span class="add_task_list">+ Add</span>
                </h4>
                <div class="task_con">
                    <ul>
                        @if (isset($task_lists) && !empty($task_lists))
                            <li class="list_btn"><a href="" onclick="location.reload(); return false;">All Lists</a> <span class="task_counter">{{ $task_lists->count() }}</span>
                            </li>
            ...
            <div class="accr_btn">
                ...
                <i class="fa-solid fa-circle-chevron-left text-light accr_btn_ac"></i>
            </div>
        </div>
