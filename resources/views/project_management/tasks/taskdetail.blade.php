            ...
            <div class="task">
                ...
                <div class="file">
                    ...
                    @if (!empty($task->{'file_name'}))
                        ...
                        <a href="{{ url(basename($task->file_name)) }}"
                            target="_blank">{{ basename($task->file_name) }}</a>
                        {{--  --}}
                    @endif
...
<style>
    ...
    .task hr {
        border-color: #ccc;
        /* Change to your desired gray color */
    }
    ...
    .edit-task-option {
        ...
        border: none;
        border-radius: 12px;
        /* Adjust the value for the desired radius */
    ...
    .edit-task-option:hover {
        ...
        /* Change the hover color if desired */
    }
